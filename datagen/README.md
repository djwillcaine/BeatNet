...
1. Download the generator from [here](https://github.com/cainy393/BeatNet/releases/download/v0.4/v0.4.zip) and extract the zip file to somewhere convenient such as the Desktop.

	[![](https://dabuttonfactory.com/button.png?t=Download&f=Open+Sans-Bold&ts=20&tc=fff&tshs=1&tshc=000&hp=20&vp=8&c=round&bgt=unicolored&bgc=3d85c6)](https://github.com/cainy393/BeatNet/releases/download/v0.4/v0.4.zip)
